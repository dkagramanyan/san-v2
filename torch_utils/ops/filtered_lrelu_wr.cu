...
template filtered_lrelu_kernel_spec choose_filtered_lrelu_kernel<c10::BFloat16, int32_t, true, false>(const filtered_lrelu_kernel_params& p, int sharedKB);
...
template filtered_lrelu_kernel_spec choose_filtered_lrelu_kernel<c10::BFloat16, int64_t, true, false>(const filtered_lrelu_kernel_params& p, int sharedKB);
...
template void* choose_filtered_lrelu_act_kernel<c10::BFloat16, true, false>(void);
